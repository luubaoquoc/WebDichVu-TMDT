...
const HeaderComponent = () => {
  ...
  const navigationItems_user = user
    ? [
        {
          key: "sub1",
          label: "My Account",
          children: [
            {
              key: "i1",
              label: <Link to="/profile-user">My Profile</Link>,
            },
            {
              key: "i2",
            ...
            {
              key: "i3",
              label: <Link to="/my-order-service">Service Orders</Link>,
            },
            {
              key: "i4",
    ...
    : [
        {
          key: "login",
          label: <div onClick={() => setIsModalOpen(true)}>Login</div>,
        },
      ];
  const navigationItems = [
    ...navigationItems_user,
    {
      type: "sub22",
      label: (
        <div
        ...
        >
          CART
          <Badge count={order.orderItems?.length} size="small" showZero>
            <ShoppingCartOutlined
    ...
    },
    {
      ...
      children: [
        {
          key: "i20",
          label: <Link to="/products">Trang chủ sản phẩm</Link>,
        },
        {
          key: "i5",
    ...
    },
    {
      ...
      children: [
        {
          key: "i11",
          label: <Link to="/installationservice">Lắp đặt điện lạnh</Link>,
        },
        {
          key: "i12",
          label: (
            <Link to="/refrigerationrepairservice">Sửa chữa điện lạnh</Link>
          ),
        },
        {
          key: "i13",
          label: (
            <Link to="/waterandelectricityinstallationservice">
              Lắp đặt điện nước
            </Link>
          ),
        },
        {
          key: "i14",
          label: (
            <Link to="/waterandelectricityrepairservice">
              Sửa chữa điện nước
            </Link>
          ),
        },
        {
          key: "i15",
          label: <Link to="/plasterpaintservice">Sơn bả và thạch cao</Link>,
        },
      ],
    },
    {
      key: "sub8",
      label: <Link to="/orderservice">Đặt lịch dịch vụ</Link>,
    },
    {
      key: "sub6",
  ...
  return (
    <HeaderContainer>
      <WrapperHeader align="middle" justify="space-between">
        <Col
          xl={0}
          lg={0}
          md={2}
        ...
        >
          <Tooltip title="Danh mục điều hướng">
            <Button
              size="large"
              type="text"
              icon={<MenuOutlined />}
        ...
        {/* Logo + Tên Cửa Hàng */}
        <Col xl={18} lg={18} md={16} sm={19} xs={19}>
          <Row gutter={[0, 16]} align="middle" justify="center">
            ...
            <Col xl={16} lg={16} md={24} sm={24} xs={24}>
              <Row justify="center" align="middle" style={{ width: "100%" }}>
                <SearchButton xl={0} lg={0} md={2} sm={3} xs={3}>
                  <Popover
                    ...
                    content={
                      <Input
                        suffix={<SearchIcon />}
                        placeholder="Bạn cần tìm sản phẩm/dịch vụ gì?"
                        allowClear
                        size="medium"
                  ...
                  >
                    <Button shape="circle" icon={<SearchIcon />}></Button>
                  </Popover>
                </SearchButton>
                <Col
                  xl={0}
                ...
                {/* Thanh tìm kiếm */}
                <SearchWrapper xl={14} lg={14} md={0} sm={0} xs={0}>
                  <Input
                    suffix={<SearchIcon />}
                    placeholder="Bạn cần tìm sản phẩm/dịch vụ gì?"
                    allowClear
                ...
                {/* Hotline */}
                <Hotline xl={10} lg={10} md={15} sm={15} xs={15}>
                  <HotlineText gutter={[5, 0]} justify="center" align="middle">
        ...
        {/* Login + Cart */}
        <AuthCart xl={6} lg={6} md={6} sm={4} xs={4}>
          <Row
            gutter={[0, 16]}
            justify="start"
            align="middle"
